...
const {serviceImageUrl , servicePrice , serviceTitle } = orderInformations ;
...
setOrders(newOrder)
    ...
    return (
        <div className='mx-auto justify-center'>
            <h2 className='text-2xl font-bold text-center my-5 text-green-400'> Check out service page </h2>
            ...
            <textarea rows="5" minLength="10" maxLength="50" name='orderMessage'  onChange={handleInputFeild}   className="textareaFeild my-4 px-4 py-4  rounded-md " style={{width:"80%" , border:"3px solid pink"}}
             placeholder="You can give us your home address and some message " required></textarea >
       <button type='submit' className="btn btn-primary my-4 px-4 py-4  rounded-md " style={{width:"80%"}}> Check out service </button>
            </form>
        </div>
    );
};
